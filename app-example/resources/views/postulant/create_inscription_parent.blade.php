...
<div class="content-table"> 
  ...
  <div class="row">
    ...
    <div class="col-md-3">
        <h3 class="left"><i class="fa fa-user"></i>{{ __('Planilla de Inscripción Padre') }}</h3> 
    </div>
    ...
    <div class="col-md-9">
      ...
      <div class="content-space te-0">
        ...
        {{ Form::open(['route'=>'postulant.store_representative','id'=>'frmStore','autocomplete'=>'Off','class' => 'validate' ]) }}
        ...
        <div class="form-check">
          ...
          <div class="col-5 mx-auto">
              {{ Form::button(__('Siguiente'), ['class' => 'btn btn-primary save', 'id' => 'save', 'type' => 'submit']) }}
          </div>
        {{ Form::close() }}
      </div>
    </div>
